/**
 * Cloudflare Worker — 学校官网 API 后端
 * 零依赖，通过 Cloudflare Pages 的 _worker.js 路由自动加载
 *
 * 绑定要求：
 *   KV Namespace binding = "DB"
 *   Variable ADMIN_PASSWORD (可选)
 */
...
export default {
  async fetch(request, env, ctx) {
    // Ensure KV is seeded on first request
    ...
    // ── Not found for any non-API route ──
